...
{ 
	...
	glTexImage2D(GL_TEXTURE_2D, 0, 4, surface->w, surface->h, 0, GL_RGBA, GL_UNSIGNED_BYTE, surface-
>pixels); 
...
int main(int argc, char *argv[])
{
	...
	displayWindow = SDL_CreateWindow("Gary's Game", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 
800, 600, SDL_WINDOW_OPENGL);
	...
	while (!done) 
	{
		...
		else if (caught == false) 
		{
			...
			GLfloat beamColor[] = { 0.8f, 0.0f, 0.0f, 0.8f, 0.0f, 0.0f, 0.8f, 0.0f, 0.0f, 0.8f, 
0.0f, 0.0f };
